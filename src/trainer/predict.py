...
from src.callbacks.predict_callbacks import PredictCallback
...
def test(conf: omegaconf.DictConfig) -> None:
    ...
    if conf.train.evaluation_print:
        callbacks_store.append(PredictCallback(output_val_path=conf.train.output_val_path, output_test_path=conf.train.output_test_path))
...
@hydra.main(config_path="../../conf", config_name="rag_ent")
