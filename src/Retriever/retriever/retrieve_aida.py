...
def compute_retriever_stats(dataset, top_k) -> None:
    ...
    for sample in dataset:
        window_candidates = sample["candidates_RETRIEVER"]
            ...
            for documents_batch in tqdm.tqdm(dataloader):
                ...
                if len(retrieved_accumulator) % 300_000 == 0:
                    ...
                    for sample, retrieved in zip(
                        ...
                        sample["candidates_RETRIEVER"] = [
                            {
                                **candidate.document.to_dict(),
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--index_precision", type=str, default="fp32")
